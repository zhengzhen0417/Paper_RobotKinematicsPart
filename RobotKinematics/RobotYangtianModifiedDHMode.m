...
L5 = Link('d', 120.179 , 'a', 0,        'alpha', pi/2,      'offset',0,         'modified');
...
%modmyt06=myfkine(MDH,deg2rad(-6.75),deg2rad(-5.48),deg2rad(-117.13),deg2rad(44.60),deg2rad(90.08),deg2rad(35.49))   ;    %手写的正解函数
